...
hierarchia klas Objective-C, udostępniająca trójwarstwową architekturę
...
Pliki nagłówkowe biblioteki baz danych GNUstepa.
...
Pliki nagłówkowe interfejsu PostgreSQL do GNUstepa.
...
Pliki nagłówkowe interfejsu Sybase/MS SQL do GNUstepa.
